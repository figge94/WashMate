...
export const washerControlPanel: {
  knappar: Knapp[];
...
export const dryerControlPanel: {
  knappar: Knapp[];
  indikatorer: Indikator[];
} = {
  knappar: [
    {
      ...
      symbolKey: "programvred",
      namn: "Programvred",
      beskrivning: "Här väljer du vilket torkprogram som ska köras.",
      nar: "Används först när du ska välja typ av torkning, till exempel bomull, syntet eller tidsstyrd torkning."
    },
    {
      id: 102,
      symbolKey: "temperatur",
      namn: "Torknivå / temperatur",
      beskrivning: "Styr hur skonsamt eller intensivt torkningen ska ske.",
      nar: "Bra när du vill anpassa torkningen efter känsliga plagg eller tjockare textilier."
    },
    {
      id: 103,
      symbolKey: "fordrojdStart",
      namn: "Fördröjd start",
      beskrivning: "Gör att torkprogrammet startar senare.",
      nar: "Bra om du vill att torkningen ska bli klar en viss tid."
    },
    {
      id: 104,
      symbolKey: "quick",
      namn: "Quick",
      beskrivning: "Kortar ner tiden när det är möjligt.",
      nar: "Bra för mindre mängder eller lättare plagg som ska torkas snabbt."
    },
    {
      id: 105,
      symbolKey: "startPaus",
      namn: "Start/Paus",
      beskrivning: "Startar eller pausar det valda programmet.",
      nar: "Tryck när du är klar med dina val och vill starta torkningen."
    }
  ],
  indikatorer: [
    {
    ...
    },
    {
      symbolKey: "programKlart",
      namn: "Program klart",
      beskrivning: "Visar att torkningen är färdig."
    },
    {
      symbolKey: "barnlas",
      namn: "Barnlås",
